...
Route::middleware('auth')->prefix('v1')->group(function () {
    ...
    Route::get('/project/{id}/in-progress-tasks', 'Project\ProjectApiController@getInProgressList');
...
Route::middleware('auth')->prefix('v1')->group(function () {
    Route::get('/task/suggest-list', 'TaskApiController@getTaskSuggestionList');
